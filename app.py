...
st.markdown("""
    ...
    .stButton>button p { color: #000000 !important; font-weight: 900 !important; font-size: 1.2rem !important; }

    .report-box { background-color: #FFFFFF !important; padding: 25px; border: 5px solid #FFCC00; border-radius: 10px; }
    .report-box h3, .report-box p, .report-box b, .report-box span { color: #000000 !important; }
    </style>
